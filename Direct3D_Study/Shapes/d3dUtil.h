...
public:
    ...
    //기본 버퍼의 자료를 초기화하려면 항상 임시 업로드 버퍼가 필요
    // 다음과 같은 편의용 함수를 제공 CreateDefaultBuffer()
...
struct SubmeshGeometry
{
    ...
    // 이 부분 메시가 정의하는 기하구조의 경계 상자(바운딩 박스)
...
struct MeshGeometry
{
	...
	// 시스템 메모리 복사본. 정점/색인 형식이 범용적일 수 있으므로 블로브를 사용한다.
    ...
    Microsoft::WRL::ComPtr<ID3DBlob> ColorBufferCPU = nullptr; //Microsoft::WRL::
    Microsoft::WRL::ComPtr<ID3D12Resource> ColorBufferGPU = nullptr; //Microsoft::WRL::
    Microsoft::WRL::ComPtr<ID3D12Resource> ColorBufferUploader = nullptr; //Microsoft::WRL::
	...
	// 한 MeshGeometry 인스턴스의 한 정점/색인 버퍼에 여러 개의 기하구조를 담을 수 있다.
