    ...
    Microsoft::WRL::ComPtr<ID3D12Resource>& uploadBuffer)
{
    ...
    // 임시 업로드 힙에 복사하고, ID#D12CommandList::CopySubresourceRegion을
    // 이용해서 임시 업로드 힙의 자료를 mBUffer에 복사한다.
